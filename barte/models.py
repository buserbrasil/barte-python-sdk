...
@dataclass
class CreateChargeSplitRequest:
    sellers: List[CreateChargeSplitSeller]


@dataclass
class ChargeSplitValue:
    idSeller: int
    splitValue: float


@dataclass
class CreateChargeSplitResponse:
